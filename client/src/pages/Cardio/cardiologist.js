...
function Cardiologist() {
  ...
  useEffect(() => {
    Axios.get("https://dbms-project-final.herokuapp.com/api/patients/cardio").then((response) => {
  ...
  return (
    <div>
       <div>
        <h1 style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', }}>Welcome Cardiologist!</h1>
