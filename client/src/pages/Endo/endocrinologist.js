...
function Endocrinologist() {
  ...
  useEffect(() => {
    Axios.get("https://dbms-project-final.herokuapp.com/api/patients/endo").then((response) => {
  ...
  return (
    <div>
       <div>
        <h1 style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', }}>Welcome Endocrinologist!</h1>
